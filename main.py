...
# Конфигурация (замените эти значения на реальные)
BOT_TOKEN = 'YOUR_TELEGRAM_BOT_TOKEN'  # Замените на токен вашего бота
MANAGER_USERNAME = '@manager_username'  # Замените на username менеджера
MANAGER_CHAT_ID = 123456789  # Замените на chat_id менеджера
    ...
    if callback.data in service_names:
        ...
        if callback.from_user.id in user_states:
            ...
            bot.send_message(
                ...
                'Менеджер свяжется с вами ' + MANAGER_USERNAME + '\n\n'
